...
about a teaching record: *what was it, how real was it, who was it pitched at,
...
**`audience` third.** It is the calibration: the same title in front of second-
year students and in front of a company's engineers is two different sessions.
It sits third because it qualifies the session rather than describing it.
...
| `audience` | `Engineering Students` · `Professionals` · `Professionals & Trainees` · `Mixed` |
...
- **Subject.** *Assembly*, *Python*, *Competitive Programming* are already in
  ...
  the bullets.
- **Attendance.** No count was recorded for any of these sessions. Per rule 5
  the category simply does not exist rather than being filled with estimates.
